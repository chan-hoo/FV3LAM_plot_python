###################################################################### CHJ #####
## Name		: plot_fv3lam_prslev.py
## Language	: Python 3.7
## Usage	: Plot output 'PRSLEV(BGDAWP)' files for fv3 regional modeling
## Input files  : PRSLEVXX.tmXX(BGDAWP)
## NOAA/NWS/NCEP/EMC
## History ===============================
...
dnm_data="/scratch2/NCEPDEV/stmp3/Chan-hoo.Jeon/expt_dirs/test_cmaq_conus13/2019080112/postprd/"
...
# Input file (BGDAWP / PRSLEV)
#fnm_in='rrfs.t00z.bgdawp'+fnm_hr+'.tm00.grib2'
fnm_in='rrfs.t12z.prslev'+fnm_hr+'.tm00.grib2'
